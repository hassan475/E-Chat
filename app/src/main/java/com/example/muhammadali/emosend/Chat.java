...
public class Chat extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String msgtext ="";
                msgtext=new_message.getText().toString();

                try {
                    Intent intent=new Intent(Chat.this,emoActivity.class);
            ...
            public void onClick(View v) {
                ...
                if(text.length()>0) {
                    ...
                    if(Function.sendSMS(address, tmp_msg))
                    {
                        ...
                        customList.add(Function.mappingInbox(null, null, null, null, tmp_msg, "2", null, "sent"));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
            ...
            if(requestCode==1)
            {
                ...
                String msgtxt=data.getStringExtra("msgWithEmoji").toString();
                if (!(msgtxt.isEmpty())) {
